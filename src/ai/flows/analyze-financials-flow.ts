...
يركز المستخدم حاليًا على الشهر: {{currentMonthFocus.year}}-{{currentMonthFocus.month}}. (الشهر مُفهرس من 1، على سبيل المثال، 1 لشهر يناير). عند الإشارة إلى الأشهر بتنسيق YYYY-MM، يرجى التأكد دائمًا من تمثيل الشهر برقمين (على سبيل المثال، يناير كـ 01، فبراير كـ 02، إلخ).
